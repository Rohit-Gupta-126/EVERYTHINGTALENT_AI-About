        ...
        <div className="absolute right-0 mt-2 w-36 bg-white/40 dark:bg-black/50 border border-white/30 dark:border-black/20 rounded-lg shadow-lg p-2 backdrop-blur-lg space-y-2">
          <div className="rounded-lg background-gradient p-0.5">
            <button
              ...
              className="flex items-center w-full px-4 py-2 text-sm text-slate-900 dark:text-slate-100 bg-slate-200/80 dark:bg-black/70 rounded-lg backdrop-blur-md group hover:bg-gradient-to-r from-[#B11AFF]/20 to-[#FF689F]/20 hover:scale-[101%] transition-transform duration-200 shadow-lg"
            >
