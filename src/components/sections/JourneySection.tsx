...
export default function JourneySection() {
  const milestones = [
    {
      ...
      imageUrl: "https://www.everythingtalent.ai/_next/image?url=%2Fassets%2Fabout-us%2F2024.jpg&w=1536&q=75",
      description:
    ...
    },
    {
      ...
      imageUrl: "https://www.everythingtalent.ai/_next/image?url=%2Fassets%2Fabout-us%2F2023.jpg&w=1280&q=75",
      description:
    ...
    },
    {
      year: "2022",
      title: "The Beginning",
      imageUrl: "https://www.everythingtalent.ai/_next/image?url=%2Fassets%2Fabout-us%2F2022.jpg&w=1280&q=75",
      description:
  ...
  return (
    <section className="py-16 px-4 bg-white dark:bg-slate-950 lg:py-28 relative">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-5xl font-bold tracking-tight mb-6 mt-4">
